...
function CheckoutForm({ clientSecret, property }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="border rounded shadow-sm mt-5 p-4 bg-light">
                  ...
                  <div className="col-6">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <span className="fw-bold">${property.rent_amount}/month</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <span className="fw-bold">{property.city}, {property.state}</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <span className="fw-bold">{property.category.name} Bedrooms</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="card-body p-3">
              {reviews.length > 0 ? (
                <div className="list-group">
                  {reviews.map((review) => (
                    <div key={review.id} className="list-group-item list-group-item-action p-3 mb-2 bg-light rounded">
